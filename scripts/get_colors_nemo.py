...
if __name__ == '__main__':
    ...
    # episode = episode + '/'
    # dir_path = '/Volumes/SG-1TB/nemo/screenshots/'  #for raw images
    dir_path = '/Users/fredhohman/Github/a-viz-of-ice-and-fire/data/nemo/color-palettes-chunk60-temp/'  # for chunked pngs
    # dir_path = episode
