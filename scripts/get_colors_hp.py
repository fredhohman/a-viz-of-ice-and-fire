...
if __name__ == '__main__':
    ...
    # episode = episode + '/'
    # dir_path = '/Volumes/SG-1TB/hp/7-2-screenshots/'  #for raw images
    dir_path = '/Users/fredhohman/Github/a-viz-of-ice-and-fire/data/hp/7-2-color-palettes-chunk-temp/'  # for chunked pngs
    # dir_path = episode
    ...
    for cpal in palettes:
        ...
        posx = 0
    del draw
    pal.save('../data/hp/hp-7-2-chunked.png', "PNG")

    with open('../data/hp/hp-7-2-chunked.json', 'w') as outfile:
