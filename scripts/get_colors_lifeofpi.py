...
if __name__ == '__main__':
    ...
    # episode = episode + '/'
    # dir_path = '/Volumes/SG-1TB/lifeofpi/screenshots/'  #for raw i./mages
    dir_path = '/Users/fredhohman/Github/a-viz-of-ice-and-fire/data/lifeofpi/color-palettes-chunk-temp/'  # for chunked pngs
    # dir_path = episode
